...
const Aboutsec = () => {
  return (
    <section className="flex flex-col md:flex-row mt-24 md:mt-72 space-y-10 md:space-y-0 md:space-x-8 lg:space-x-32 px-4 md:px-12 lg:px-24">
      ...
      <div className="mt-8 md:mt-20 text-center md:text-left">
        ...
        <p className="border-2 border-gray-300 mt-8 md:mt-16 rounded-full"></p>
      </div>
    </section>
  );
};
